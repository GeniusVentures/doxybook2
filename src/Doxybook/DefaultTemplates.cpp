...
{% for child0 in children %}* **{{child0.kind}} [{{child0.title}}]({{child0.url}})** {% if existsIn(child0, "brief") %}<br/>{{child0.brief}}{% endif %}{% if existsIn(child0, "children") %}{% for child1 in child0.children %}
    * **{{child1.kind}} [{{ displayTitle(child1) }}]({{child1.url}})** {% if existsIn(child1, "brief") %}<br/>{{child1.brief}}{% endif %}{% if existsIn(child1, "children") %}{% for child2 in child1.children %}
        * **{{child2.kind}} [{{ displayTitle(child2) }}]({{child2.url}})** {% if existsIn(child2, "brief") %}<br/>{{child2.brief}}{% endif %}{% if existsIn(child2, "children") %}{% for child3 in child2.children %}
            * **{{child3.kind}} [{{ displayTitle(child3) }}]({{child3.url}})** {% if existsIn(child3, "brief") %}<br/>{{child3.brief}}{% endif %}{% if existsIn(child3, "children") %}{% for child4 in child3.children %}
                * **{{child4.kind}} [{{ displayTitle(child4) }}]({{child4.url}})** {% if existsIn(child4, "brief") %}<br/>{{child4.brief}}{% endif %}{% if existsIn(child4, "children") %}{% for child5 in child4.children %}
                    * **{{child5.kind}} [{{ displayTitle(child5) }}]({{child5.url}})** {% if existsIn(child5, "brief") %}<br/>{{child5.brief}}{% endif %}{% if existsIn(child5, "children") %}{% for child6 in child5.children %}
                        * **{{child6.kind}} [{{ displayTitle(child6) }}]({{child6.url}})** {% if existsIn(child6, "brief") %}<br/>{{child6.brief}}{% endif %}{% if existsIn(child6, "children") %}{% for child7 in child6.children %}
                            * **{{child7.kind}} [{{ displayTitle(child7) }}]({{child7.url}})** {% if existsIn(child7, "brief") %}<br/>{{child7.brief}}{% endif %}{% endfor %}{% endif %}{% endfor %}{% endif %}{% endfor %}{% endif %}{% endfor %}{% endif %}{% endfor %}{% endif %}{% endfor %}{% endif %}{% endfor %}{% endif %}
{% endfor %}
)~~~";
